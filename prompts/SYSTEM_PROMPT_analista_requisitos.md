...
> - `PROMPT_PROTOTYPE_FLOW_FULL.md` / `PROMPT_PROTOTYPE_FLOW_COMPONENT.md` — fluxo do Feature Set, com ou sem shell (requer N2 aprovado)
> - `PROMPT_PROTOTYPE_SCREEN_FULL.md` / `PROMPT_PROTOTYPE_SCREEN_COMPONENT.md` — estados da feature, com ou sem shell (requer N3 aprovado)
>
