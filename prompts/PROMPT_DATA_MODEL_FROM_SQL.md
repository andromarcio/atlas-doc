...
| **Junção (N:N)** | PK composta de 2 FKs, sem (ou quase sem) outros atributos | **Não** vira entidade isolada; vira relacionamento + candidata a RET da ALI relacionada |
...
- **TD (Tipos de Dado / DET)**: campos únicos reconhecíveis pelo usuário.
...
- **TR (Tipos de Registro / RET)**: subgrupos lógicos. Mínimo 1 (a própria entidade);
...
| Entidade | Domínio | Tipo | TD | TR | Complexidade | PF |
|---|---|---|---|---|---|---|
| [Entidade] | [Dominio] | ALI | [n] | [n] | [c] | [pf] |
| ... | | | | | | |
| **Total** | | | | | | **[soma] PF** |
