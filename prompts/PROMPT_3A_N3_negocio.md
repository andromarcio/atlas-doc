...
Se o N2 foi fornecido, leia o ID do Feature Set (`[SIGLA]-[NNN]`) e liste as features.
Atribua a cada feature um ID sequencial de 2 dígitos (`[SIGLA]-[NNN]-01`, `-02`…),
respeitando IDs já existentes. Pergunte:

> "Identifiquei as seguintes features em **[Feature Set]** (`[SIGLA]-[NNN]`):
>
> | Feature | ID |
> |---|---|
> | [Nome] | [SIGLA]-[NNN]-01 |
...
> ⚠️ ID provisório atribuído: **[SIGLA]-[NNN]-[NN]** — confirmar quando o N2 for gerado via B2.
>
