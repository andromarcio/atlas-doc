...
| Prompt | O que gera |
|---|---|
| `prompts/PROMPT_PROTOTYPE_FLOW_FULL.md` | Protótipo de fluxo (com shell) a partir do N2 |
| `prompts/PROMPT_PROTOTYPE_FLOW_COMPONENT.md` | Protótipo de fluxo (sem shell) a partir do N2 |
| `prompts/PROMPT_PROTOTYPE_SCREEN_FULL.md` | Protótipos de estado (com shell) a partir do N3 |
| `prompts/PROMPT_PROTOTYPE_SCREEN_COMPONENT.md` | Protótipos de estado (sem shell) a partir do N3 |
